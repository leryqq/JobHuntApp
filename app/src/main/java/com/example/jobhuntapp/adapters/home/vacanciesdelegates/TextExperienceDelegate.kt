...
class TextExperienceDelegate : AdapterDelegate<List<Any>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        return TextExperienceViewHolder(view)
    }
    ...
    override fun onBindViewHolder(
        ...
        (holder as TextExperienceViewHolder).bind(item)
    }

    class TextExperienceViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val textView: TextView = view.findViewById(R.id.textView_experience)

        fun bind(item: Vacancies) {
            textView.text = item.experience.previewText
        }
    }
}