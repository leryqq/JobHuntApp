...
class TextTitleDelegate : AdapterDelegate<List<Any>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        return TextTitleViewHolder(view)
    }
    ...
    override fun onBindViewHolder(
        ...
        (holder as TextTitleViewHolder).bind(item)
    }

    class TextTitleViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val textView: TextView = view.findViewById(R.id.textView_vacancyTitle)
